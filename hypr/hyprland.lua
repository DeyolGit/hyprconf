...
--Basic use of vim and neovim as a text editor for proffesiioanl programmers and true opsec users
...
hl.animation({ leaf = "windowsIn", enabled = true, speed = 4, bezier = "smooth", style = "slide bottom" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 4, bezier = "smooth", style = "slide bottom" })
...
hl.bind("CTRL" .. " + " .. "F", hl.dsp.exec_cmd("flatpak run io.gitlab.librewolf-community"))

hl.bind(mainMod .. " + " .. "C", hl.dsp.exec_cmd("flatpak run io.gitlab.librewolf-community http://192.168.0.32:8081/"))

hl.bind(mainMod .. " + " .. "F", hl.dsp.window.fullscreen())

hl.bind("CTRL" .. " + " .. "J", hl.dsp.exec_cmd("flatpak run com.github.iwalton3.jellyfin-media-player"))

-- Screenshot a window  AAAAAAA

hl.bind(mainMod .. " + " .. "END", hl.dsp.exec_cmd("hyprshot -m window"))

-- Screenshot a monitor

hl.bind(mainMod .. " + " .. "INSERT", hl.dsp.exec_cmd("hyprshot -m output"))
...
hl.bind("ALT" .. " + " .. "up", hl.dsp.exec_cmd("ddcutil setvcp 10 --relative +10"))

hl.bind("ALT" .. " + " .. "down", hl.dsp.exec_cmd("ddcutil setvcp 10 --relative -10"))
...
-- Ignore maximize requests from apps. You'll probably like thqqqqis.
